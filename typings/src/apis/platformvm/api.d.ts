...
import { GetRewardUTXOsResponse, GetStakeResponse } from "../../common";
/**
...
export declare class PlatformVMAPI extends JRPCAPI {
     ...
     */
    createSubnet: (username: string, password: string, controlKeys: string[], threshold: number) => Promise<string>;
    /**
