...
export declare class AVMAPI extends JRPCAPI {
    ...
    */
     ...
     */
    send: (username: string, password: string, assetID: string | Buffer, amount: number | BN, to: string, from?: string[] | Buffer[], changeAddr?: string, memo?: string | Buffer) => Promise<{
        txID: string;
        changeAddr: string;
    }>;
    /**
    ...
    sendMultiple: (username: string, password: string, sendOutputs: {
        ...
        amount: number | BN;
        to: string;
    }[], from?: string[] | Buffer[], changeAddr?: string, memo?: string | Buffer) => Promise<{
        txID: string;
        changeAddr: string;
    }>;
    /**
